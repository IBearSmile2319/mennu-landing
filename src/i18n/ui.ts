...
export const ui = {
    es: {
        ...
        // ++++++++++
        // banner
        'home.banner.title': 'Comida BARATA y BUENA cerca de ti',
        'home.banner.subtitle': 'Come rico, come bien… menús económicos al alcance de tu bolsillo en lugares cercanos a donde te encuentres.',
        'home.banner.button': 'Descarga la APP',
        // section 1
        'home.section1.title': '¿Por qué usar la APP de Mennu?',
        // ilustaciones con su titulo y descripcion
        'home.section1.illustration1.title': 'Variedad de lugares de comida',
        'home.section1.illustration1.description': 'Puedes escoger entre restaurantes, puestos de comida y cocina en casa.',
        'home.section1.illustration2.title': 'Cerca de ti',
        'home.section1.illustration2.description': 'Te indica los lugares de comida que están más cerca de ti y el tipo de atención que tienen: presencial, delivery y para recoger.',
        'home.section1.illustration3.title': 'Variedad de menús',
        'home.section1.illustration3.description': 'Información real sobre el menú que ofrece cada lugar. Puedes escoger lo que te gusta comer.',
    },
    en: {
        // ++++++++++
        // HEAD
        ...
        // ++++++++++
        // banner
        'home.banner.title': 'CHEAP and GOOD food near you',
        'home.banner.subtitle': 'Eat well, eat well ... economic menus within reach of your pocket in places close to where you are.',
        'home.banner.button': 'Download the APP',
        // section 1
        'home.section1.title': 'Why use the Mennu APP?',
        // ilustaciones con su titulo y descripcion
        'home.section1.illustration1.title': 'Variety of food places',
        'home.section1.illustration1.description': 'You can choose between restaurants, food stalls and home cooking.',
        'home.section1.illustration2.title': 'Close to you',
        'home.section1.illustration2.description': 'It indicates the food places that are closest to you and the type of attention they have: face-to-face, delivery and for pick-up.',
        'home.section1.illustration3.title': 'Variety of menus',
        'home.section1.illustration3.description': 'Real information about the menu offered by each place. You can choose what you like to eat.',
    },
} as const;
